...
app.get("/response", async (req, res) => {
    ...
    const wallet = await validateUserWallet(_id);

    // create wallet transaction
    await createWalletTransaction(_id, status, currency, amount);

    // create transaction
    await createTransaction(_id, id, status, currency, amount, customer);

    await updateWallet(_id, amount);
